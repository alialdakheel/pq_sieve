...
class PQSieve():
    def __init__(self,
        ...
        self.b0_ind = np.searchsorted(self.R, sqrt_n_mod_h, side='left')
        self.b0 = self.R[self.b0_ind]
    ...
    def _compute_Rx_np(self):
        ...
        for i in range(2, len(self.h)):
            Rx = _compute_Rcrt(self.h[i], x, np.array(self.R_list[i], dtype=int), Rx)
            #del Rx
            #Rx = Rx2
            #del Rx2
            x *= self.h[i]
...
if __name__ == "__main__":
    ...
    #pqs10 = PQSieve(3677169269011909330112649617, h=[], num_p=11)
    #res10 = pqs10.search()
    #print(res10)
